...
@property (nonatomic, unsafe_unretained) SCRecordingSaveViewControllerHeaderView *headerView;
@property (nonatomic, unsafe_unretained) SCRecordingUploadProgressView *uploadProgressView;
                                  ...
                                  sendingProgressHandler:^(unsigned long long bytesSend, unsigned long long bytesTotal){self.uploadProgressView.progress.progress = (float)bytesSend / bytesTotal;}
                                         responseHandler:^(NSURLResponse *response, NSData *data, NSError *error){
                                             ...
                                             if (error || jsonError || result == nil) {
                                                 ...
                                                 [toolbarItems addObject:[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil]];
                                                 [toolbarItems addObject:[[UIBarButtonItem alloc] initWithTitle:SCLocalizedString(@"done", @"Done") style:UIBarButtonItemStyleBordered target:self action:@selector(close)]];
